@include('partials.header')
    <header class="max-w-lg mx-auto">
        <a href="">
            <h1 class="text-4xl text-white font-bold text-center">Account Register</h1>
        </a>
    </header>
        ...
        <section class="mt-10">
            <form action="/store" method="POST" class="flex flex-col">
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    ...
                    <input type="password" name="password_confirmation" id="" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3" >
